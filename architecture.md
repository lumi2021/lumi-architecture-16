...
Copy data from flags register into register `r0`
...
Copy data from register `r0` into flags register
...
| :-: | :------: | :-----: | :-: | :-----: | --- | :-----------: | :------------: |
|  1  |  011000  |  flag   |  V  |  00000  |     | imm0 low byte | imm0 high byte |
...
| :-: | :------: | :---------: | :-: | ------------- | :------------: |
|  1  |  011010  |     \*      |     | imm0 low byte | imm0 high byte |
